            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot sn : dataSnapshot.getChildren()){
                    ...
                    if (DataFilter.getFiltered()){
                        if(sn.child("kategoriSampah").getValue(String.class).equalsIgnoreCase("kaca") && sn.child("statusSampah").getValue(String.class).equalsIgnoreCase("Available")&& Integer.parseInt(sn.child("hargaSampah").getValue(String.class))<=Integer.parseInt(DataFilter.getMaxHarga())&& (jarakMeter/1000)<=Float.parseFloat(DataFilter.getMaxJarak())){
                        ...
                        if (sn.child("kategoriSampah").getValue(String.class).equalsIgnoreCase("kaca") && sn.child("statusSampah").getValue(String.class).equalsIgnoreCase("Available")){
                            String img = sn.child("img").getValue(String.class);
                            String nama = sn.child("namaSampah").getValue(String.class);
                            String deskripsi = sn.child("deskripsiSampah").getValue(String.class);
                            String kategori = sn.child("kategoriSampah").getValue(String.class);
